...
const OlaMapsGeolocation = () => {
  ...
  const fetchRouteData = async () => {
    const response = await fetch(
      `https://api.olamaps.io/routing/v1/directions?origin=18.76029027465273,73.3814242364375&destination=18.73354223011708,73.44587966939002&api_key=${process.env.OLA_API_KEY}`,
      {
        method: "POST",
        headers: {
          "X-Request-Id": "XXX",
