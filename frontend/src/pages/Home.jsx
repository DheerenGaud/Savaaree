  ...
  return (
    ...
    <section id="home" className={`flex md:flex-row  flex-col sm:py-5 py-6`}>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        {/* <img src='/assets/SAVAAREE_LOGO.png' alt="billing" className="w-[100%] h-[100%] relative z-[5]" /> */}
        <div className='className="w-[100%] h-[100%] relative z-[5]"'>
           <OlaMapsComponent  height={550}  width={550} />
        </div>
